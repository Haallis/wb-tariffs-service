...
# Чтобы обеспечить работу автоматизационного сервиса записи/обновления тарифов WB В БД и google таблицы локально и в docker, выполните слудющие действия:

1. Создайте в локальном репо .env с переменными окружения как в примере конфигурации .env.example 
